...
if args.model == 'aum':
    ...
    audio_model = models.AudioMamba(
        spectrogram_size=(args.melbins, args.audio_length),  #128,1024
        patch_size=(args.fpatch_size, args.tpatch_size),#16,16
        strides=(args.fstride, args.tstride),#16,16
        depth=depth,#24
        embed_dim=embed_dim,#512
        num_classes=args.n_class, #527
        ...
        imagenet_load_middle_cls_token=args.imagenet_load_middle_cls_token,  #true
        use_double_cls_token=args.use_double_cls_token,
        use_middle_cls_token=args.use_middle_cls_token,  #true
        use_end_cls_token=args.use_end_cls_token,
        bimamba_type=bimamba_type,  #v1
        transpose_token_sequence=args.transpose_token_sequence,
        if_cls_token=args.if_cls_token,  #true
