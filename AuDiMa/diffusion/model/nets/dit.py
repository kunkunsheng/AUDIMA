...
from model.nets.blocks import t2i_modulate, CaptionEmbedder, AttentionKVCompress, MultiHeadCrossAttention, T2IFinalLayer, TimestepEmbedder, LabelEmbedder, FinalLayer
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.out_channels = in_channels if pred_sigma else in_channels
        ...
        self.base_size = (input_size[0] // self.patch_size,input_size[1] // self.patch_size)
